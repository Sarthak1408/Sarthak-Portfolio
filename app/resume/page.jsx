...
const about = {
    ...
    info: [{
        ...
        fieldName: "Email", fieldValue: "sarthakmathur1408@gmail.com",
    }, ],
};
                                ...
                                <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                                    {experience.items.map((item, index) => {
                                        return (<li key={index}
                                            ...
                                            <h3 className="text-xl max-w-[260px] min-h-[60px] items-center lg:text-left">{item.position}</h3>
                                ...
                                <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                                    {education.items.map((item, index) => {
                                        return (<li key={index}
                                                    className="bg-[#232329] h-[184px] py-6 px-10 rounded-xl flex flex-col justify-center items-center lg:items-start gap-1">
                                            <span className="text-accent">{item.duration}</span>
                                            <h3 className="text-xl max-w-[260px] min-h-[60px] items-center lg:text-left">{item.degree}</h3>
                                            <div className="flex items-center gap-3">
                                                {/*dot*/}
                                                <span className="w-[6px] h-[6px] rounded-full bg-accent"></span>
                                        ...
                                        <TooltipProvider delayDuration={100}>
                                            <Tooltip>
                                                <TooltipTrigger
                                                    ...
                                                    <div
                                                        className="text-6xl group-hover:text-accent transition-all duration-300">{skills.icons}</div>
                                                </TooltipTrigger>
                                                <TooltipContent>
